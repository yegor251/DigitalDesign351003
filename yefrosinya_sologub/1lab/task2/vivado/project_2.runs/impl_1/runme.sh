...
HD_PWD='C:/Mac/Home/Desktop/new_proj/task2/vivado/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_led_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw_led_unit.tcl -notrace
