...
HD_PWD='C:/Mac/Home/Desktop/new_proj/task2/vivado/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw_led_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw_led_unit.tcl
