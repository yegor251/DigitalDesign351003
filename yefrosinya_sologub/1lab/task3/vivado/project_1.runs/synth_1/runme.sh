...
HD_PWD='C:/Mac/Home/Desktop/new_proj/task3/vivado/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_led_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_led_unit.tcl
