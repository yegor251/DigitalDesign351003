...
HD_PWD='C:/Mac/Home/Desktop/new_proj/task3/vivado/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_led_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_led_unit.tcl -notrace
