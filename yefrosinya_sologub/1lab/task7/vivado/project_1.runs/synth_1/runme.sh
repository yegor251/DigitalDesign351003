...
HD_PWD='C:/new_proj/task7/vivado/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_task7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source converter_task7.tcl
