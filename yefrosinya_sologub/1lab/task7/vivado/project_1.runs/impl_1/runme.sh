...
HD_PWD='C:/new_proj/task7/vivado/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_task7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source converter_task7.tcl -notrace
