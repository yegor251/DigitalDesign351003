...
HD_PWD='C:/new_proj/task5/vivado/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_unit.tcl -notrace
