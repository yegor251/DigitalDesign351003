...
HD_PWD='C:/new_proj/task5/vivado/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_unit.tcl
