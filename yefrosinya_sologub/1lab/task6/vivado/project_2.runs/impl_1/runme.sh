...
HD_PWD='C:/new_proj/task6/vivado/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_task6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source converter_task6.tcl -notrace
