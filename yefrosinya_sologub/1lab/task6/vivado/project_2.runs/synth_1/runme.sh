...
HD_PWD='C:/new_proj/task6/vivado/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_task6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source converter_task6.tcl
