...
begin
    ...
    begin
        ...
        X <= "0010"; wait for T;
        assert (Y = "0000") 
            report "Code conversion for 0010 is incorrect. Simulation failed" 
            severity error;
        
        X <= "0101"; wait for T;
        assert (Y = "0001")
            report "Code conversion for 0101 is incorrect. Simulation failed"
            severity error;
            
        X <= "1001"; wait for T;
        assert (Y = "0010")
            report "Code conversion for 1001 is incorrect. Simulation failed"
            severity error;
