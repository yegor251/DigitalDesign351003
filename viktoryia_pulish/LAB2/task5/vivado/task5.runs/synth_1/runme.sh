...
HD_PWD='D:/DDS/LAB2/task5/vivado/task5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bistable_element.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bistable_element.tcl
