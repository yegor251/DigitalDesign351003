...
HD_PWD='D:/DDS/LAB2/task5/vivado/task5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bistable_element.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bistable_element.tcl -notrace
