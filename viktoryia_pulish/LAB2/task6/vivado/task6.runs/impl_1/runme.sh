...
HD_PWD='D:/DDS/LAB2/task6/vivado/task6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bistable_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bistable_ctrl.tcl -notrace
