...
HD_PWD='D:/DDS/LAB2/task6/vivado/task6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bistable_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bistable_ctrl.tcl
