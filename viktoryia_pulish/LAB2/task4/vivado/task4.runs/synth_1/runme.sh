...
HD_PWD='D:/DDS/LAB2/task4/vivado/task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_3bit.tcl
