...
HD_PWD='D:/DDS/LAB2/task4/vivado/task4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_3bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_3bit.tcl -notrace
