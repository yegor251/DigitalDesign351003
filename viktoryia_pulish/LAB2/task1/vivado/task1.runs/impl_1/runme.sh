...
HD_PWD='D:/DDS/LAB2/task1/vivado/task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log code_converter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source code_converter.tcl -notrace
