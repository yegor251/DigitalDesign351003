...
HD_PWD='D:/DDS/LAB2/task1/vivado/task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log code_converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source code_converter.tcl
