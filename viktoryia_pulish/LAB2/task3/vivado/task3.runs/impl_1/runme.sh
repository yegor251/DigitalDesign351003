...
HD_PWD='D:/DDS/LAB2/task3/vivado/task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log code_converter_delay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source code_converter_delay.tcl -notrace
