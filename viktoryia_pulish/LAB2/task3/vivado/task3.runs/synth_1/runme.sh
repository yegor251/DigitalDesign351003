...
HD_PWD='D:/DDS/LAB2/task3/vivado/task3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log code_converter_delay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source code_converter_delay.tcl
