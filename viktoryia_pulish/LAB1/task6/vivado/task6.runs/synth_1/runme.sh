...
HD_PWD='D:/DDS/LAB1/task6/vivado/task6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source converter.tcl
