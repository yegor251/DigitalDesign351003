...
HD_PWD='D:/DDS/LAB1/task6/vivado/task6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log converter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source converter.tcl -notrace
