...
HD_PWD='D:/DDS/LAB1/task7/vivado/task7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_structural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source converter_structural.tcl
