...
HD_PWD='D:/DDS/LAB1/task7/vivado/task7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log converter_structural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source converter_structural.tcl -notrace
