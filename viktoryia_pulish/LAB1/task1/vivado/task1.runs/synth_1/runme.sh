...
HD_PWD='D:/DDS/LAB1/LAB11/vivado/task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_const.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_const.tcl
