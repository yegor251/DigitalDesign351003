...
HD_PWD='D:/DDS/LAB1/LAB11/vivado/task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_const.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_const.tcl -notrace
