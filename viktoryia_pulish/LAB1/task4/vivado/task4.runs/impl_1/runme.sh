...
HD_PWD='D:/DDS/LAB1/task4/vivado/task4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log f_e8d5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source f_e8d5.tcl -notrace
