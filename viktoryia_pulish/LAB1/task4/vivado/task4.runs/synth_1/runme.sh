...
HD_PWD='D:/DDS/LAB1/task4/vivado/task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log f_e8d5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source f_e8d5.tcl
